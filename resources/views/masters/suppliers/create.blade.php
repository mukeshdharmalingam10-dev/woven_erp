    ...
    <form action="{{ route('suppliers.store') }}" method="POST" id="supplierForm">
        ...
        <div style="background: #f8f9fa; padding: 20px; border-radius: 5px; margin-bottom: 20px;">
            ...
            <div style="margin-bottom: 20px;">
                <label style="display: block; margin-bottom: 8px; color: #333; font-weight: 500;">Supplier ID</label>
                <input type="text" value="Auto Generated" disabled
                    style="width: 100%; max-width: 300px; padding: 12px; border: 1px solid #ddd; border-radius: 5px; font-size: 14px; background: #f5f5f5;">
            </div>
